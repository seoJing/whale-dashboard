...
import { DashboardCanvas, AddWidgetButton, WidgetSettingsButton } from '@features/dashboard';
import { WidgetSettingsPanel } from '@features/dashboard/components/WidgetSettingsPanel';
